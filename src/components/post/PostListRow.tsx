...
export function PostListRow({
  ...
  return (
    <Link
      to={`/posts/${post.id}`}
      className="group grid grid-cols-1 gap-3 border-b border-gray-100 px-3 py-3.5 transition last:border-b-0 hover:bg-orange-50/40 min-[40rem]:grid-cols-12 min-[40rem]:items-start min-[40rem]:gap-4 min-[40rem]:px-4 dark:border-gray-800 dark:hover:bg-orange-950/20"
    >
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 min-[40rem]:col-span-5 min-[40rem]:justify-end min-[40rem]:self-center">
