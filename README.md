...
[Pages 사이트](https://meowdule.github.io/Content/)에서 `fetch` 로 API 를 부르려면 서버의 `CORS_ORIGIN` 에 **`https://meowdule.github.io`**(프로젝트 사이트는 출처가 저장소 경로가 아니라 이 호스트입니다)를 포함해 두세요.
